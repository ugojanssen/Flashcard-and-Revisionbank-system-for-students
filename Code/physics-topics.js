window.onload = function() {
    document.getElementById("submit-button").addEventListener("click", function() {
        ...
        localStorage.setItem("physicsSelectedTopics", JSON.stringify(selectedTopics));

        window.location.href = "physics-subtopics.html";
    });
}
...
// The user is then redirected to the physics-subtopics.html page
