window.onload = function() {
    document.getElementById("submit-button").addEventListener("click", function() {
        ...
        localStorage.setItem("csSelectedTopics", JSON.stringify(selectedTopics));

        window.location.href = "cs-subtopics.html";
    });
}
...
// The user is then redirected to the cs-subtopics.html page
